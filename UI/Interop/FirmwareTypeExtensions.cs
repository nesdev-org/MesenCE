	...
	public static FirmwareFiles GetFirmwareInfo(this FirmwareType type)
	{
		switch(type) {
			...
			case FirmwareType.FDS:
				return new("disksys.rom", "FdsBios.bin") {
					new(0x2000,
			...
			case FirmwareType.PceSuperCd:
				return new("[BIOS] Super CD-ROM System (Japan) (v3.0).pce", "syscard3.pce") { new(0x40000, "E11527B3B96CE112A037138988CA72FD117A6B0779C2480D9E03EAEBECE3D9CE") };

			case FirmwareType.PceGamesExpress:
				return new("[BIOS] Games Express CD Card (Japan).pce", "gecard.pce") {
