...
public:
	DrawLineCommand(int x, int y, int x2, int y2, int color, int frameCount, int startFrame) : DrawCommand(startFrame, frameCount), _x(x), _y(y), _x2(x2), _y2(y2), _color(color)
	{
